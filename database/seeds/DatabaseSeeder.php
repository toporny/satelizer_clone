...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $available_dictionaries = array(
            ['language_id' => 'en_EN', 'count_words'=> 4500, 'language_name' => 'english', 'available_languages' => '[{"id":"es_ES", "name":"spanish"}, {"id":"ru_RU", "name":"russian"}, {"id":"fr_FR", "name":"french"},  {"id":"de_DE", "name":"deutsch"}, {"id":"pl_PL", "name":"polish"}]'],
