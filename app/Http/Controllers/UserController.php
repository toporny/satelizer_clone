...
// http://ieltsadvantage.com/2015/04/08/25-free-online-language-learning-tools/ 
    ...
    public function getWordsWithTranslationsForUser(Request $request, $language)
    {
        //http://localhost:3000/api/get_words_with_translations_for_user/en_EN?page=2

        // TODO: move this to external function generated by
        ...
        if (isset($user)) {
            ...
            $transactions = $transactions->paginate(10); // TODO: move it to config files
